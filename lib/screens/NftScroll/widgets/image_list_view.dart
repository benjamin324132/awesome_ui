import 'dart:async';
import 'dart:math';
import 'package:awesome_ui/screens/NftScroll/screens/nft_screen.dart';
      ...
      child: SizedBox(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return _ImageTile(
                image:
                    'https://raw.githubusercontent.com/Flutter-ui-dev/Flutter-ui-dev/main/speed-code/nft-app/assets/nfts/${widget.startIndex + index}.png');
          },
        ),
      ),
    );
